...
## Stack & shape
- Next.js 16 App Router + TS + Tailwind. Pages: `/` (dashboard: totals vs profile-derived targets, 7-day trend, realtime), `/login`, `/log/meal`, `/workout/new`, `/workout/[id]` (active + summary), `/profile`, `/weight`.
