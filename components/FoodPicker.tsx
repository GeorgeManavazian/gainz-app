...
export type PickedEntry = MealEntry;
...
export default function FoodPicker({ onPick, confirmLabel, successLabel, header }: {
  onPick: (entry: MealEntry) => Promise<void> | void;
  confirmLabel: string;
  successLabel?: string;
